                                ...
                                <tr>
                                   ...
                                   <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>
                                    ...
                                    <td class="jsgrid-align-center ">
                                        ...
                                        <a onclick="confirm('Bạn có chắc muốn xóa?')" href="#" title="Delete" class="btn btn-sm btn-danger waves-effect waves-light edudelet"  data-id="<?php echo $value->id ?>"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                    <?php } ?>
                                </tr>
                                <?php endforeach; ?>
